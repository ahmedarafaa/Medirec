...
namespace MediRec.Controllers
{
    ...
    public class ResourcesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ResourcesId,Name,ImageUrl,UserId")] Resources resources)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ResourcesId,Name,ImageUrl,UserId")] Resources resources)
        {
            if (ModelState.IsValid)
            {
